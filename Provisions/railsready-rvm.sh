...
ruby_version_string="2.5.3"
# ruby_source_url="http://cache.ruby-lang.org/pub/ruby/2.1/ruby-2.1.5.tar.gz"
ruby_source_url="https://cache.ruby-lang.org/pub/ruby/2.5.3/ruby-2.5.3.tar.gz"
# ruby_source_tar_name="ruby-2.1.5.tar.gz"
ruby_source_tar_name="ruby-2.5.3.tar.gz"
# ruby_source_dir_name="ruby-2.1.5"
ruby_source_dir_name="ruby-2.5.3"
